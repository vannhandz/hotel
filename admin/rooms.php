                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label fw-bold">Facalities</label>
                                <div class="row">
                                    <?php
                ...
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            ...
                            <input type="file" name="image" accept=".jpg, .png, .wedp, .jpeg" class="form-control shadow-none mb-3" required>
