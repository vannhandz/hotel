    ...
    <div class="container">
        <div class="row">
                        ...
                        if (mysqli_num_rows($img_q) > 0) {
                            ...
                            while ($img_res = mysqli_fetch_assoc($img_q)) {
                                ...
                                echo "<div class='carousel-item $active_class'>
                                    <img src='" . ROOMS_IMG_PATH . $img_res['image'] . "' class='d-block w-100 rounded'></div>";
                                $active_class = '';
                            }
                        } else {
                            echo "
                ...
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                       ...
                       price;
                        ...
                        echo <<<features
                                <div class=" mb-3">
                                    <h6 class="mb-1">Tính Năng</h6>$features_data
                                </div>
                            features;
                        ...
                        if (!$settings_r['shutdown']) {
                            ...
                            echo <<<book
                                <buttonn onclick='checkLoginToBook($login,$room_data[id])' class="btn w-100 text-white custom-bg shadow-none mb-5">Book Now</buttonn>
                                book;
                        }
                        ?>
                    </div>
            ...
            <div class="col-12 mt-4 px-4">
                ...
                <div>
                    <h5 class="mb-3">Xếp Hạng & Đánh Giá </h5>
                    <?php
                                ...
                                echo<<<reviews
                                    <div>
                                        <div class=" d-flex align-items-center mb-2">
                                             <img src="images/users/user.svg" width="30px">
